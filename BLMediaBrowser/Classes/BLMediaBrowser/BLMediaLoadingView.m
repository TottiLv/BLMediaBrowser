...
@interface BLMediaLoadingView ()

@property (nonatomic , weak)NSTimer *timer;

@end

@implementation BLMediaLoadingView
...
+ (UILabel *)showText:(NSString *)text toView:(UIView *)superView dismissAfterSecond:(NSTimeInterval)second {
    ...
    UILabel *textLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0,BL_MEDIA_SCREEN_WIDTH - 40, 40)];
    textLabel.text = text;
